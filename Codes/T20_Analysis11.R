# Scorecard Link:  http://www.espncricinfo.com/twenty20wc/engine/current/match/287873.html

mydata = read.csv("/home/kashish/Downloads/T20Matches/287873_req11.csv",row.names = NULL, header = F,skip = 21,colClasses = c("NULL",NA,NA,NA,NA,NA,NA,NA,NA,NA,NA))
