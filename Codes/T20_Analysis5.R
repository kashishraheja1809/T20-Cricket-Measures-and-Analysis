# Scorecard Link: http://www.espncricinfo.com/rsavaus/engine/current/match/238195.html


mydata = read.csv("/home/kashish/Downloads/T20Matches/238195_req5.csv",row.names = NULL, header = F,skip = 17,colClasses = c("NULL",NA,NA,NA,NA,NA,NA,NA,NA,NA,NA))
...
pres <- head(pres,-1)
runs_required<-head(runs_required, -1)
balls = 1:length(pres)
par(mar = c(5,5,2,5))
