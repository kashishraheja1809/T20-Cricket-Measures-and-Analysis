# Scorecard Link: http://www.espncricinfo.com/ci/engine/current/match/251488.html


mydata = read.csv("/home/kashish/Downloads/T20Matches/251488_req6.csv",row.names = NULL, header = F,skip = 20,colClasses = c("NULL",NA,NA,NA,NA,NA,NA,NA,NA,NA,NA))
