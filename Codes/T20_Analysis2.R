# Scorecard Link: http://www.espncricinfo.com/ci/engine/current/match/222678.html

mydata = read.csv("/home/kashish/Downloads/T20Matches/222678_req2.csv",row.names = NULL, header = F,skip = 17,colClasses = c("NULL",NA,NA,NA,NA,NA,NA,NA,NA,NA,NA))
