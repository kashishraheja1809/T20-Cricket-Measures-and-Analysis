# Scorecard Link: http://www.espncricinfo.com/ci/engine/current/match/211028.html

mydata = read.csv("/home/kashish/Downloads/T20Matches/211028_req1.csv",row.names = NULL, header = F,skip = 17,colClasses = c("NULL",NA,NA,NA,NA,NA,NA,NA,NA,NA,NA))
...
wickets = sort(wickets, decreasing = FALSE)
#wickets<- head(wickets, 0)
